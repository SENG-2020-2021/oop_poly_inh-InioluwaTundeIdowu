...
Scanner scan = new Scanner(System.in);
   System.out.print("Choose which quadilateral you want to check for: \n");
   System.out.println("Enter 'K' for Rhombus, 'S' for Square, 'T' for Trapezoid, 'R' for Rectangle and 'P' for Parallelogram");
...
//Rhombus case
       case 'K':  
	   System.out.println("Calculation for area and perimeter of a Rhombus");
       System.out.println("Input size of first side");
      float a = scan.nextFloat();
      System.out.println("Input size of second side");
      float b = scan.nextFloat();
      System.out.println("Input size of third side");
      float c = scan.nextFloat();
      System.out.println("Input size of fourth side");
      ...
      break;
//Square case
      case 'S': System.out.println("Calculation for area and perimeter of a square");
...
//Trapezoid case
      case 'T':
     System.out.println("Calculation for area and perimeter of a Trapezoid");
    ...
    System.out.println("");
      ...
      break;
//Rectangle case
      case 'R': System.out.println("Calculation for area and perimeter of a rectangle");
...
//this should be in the parallelogram case
      ...
      case 'P': System.out.println("This program calculates the area and perimeter of the parallelogram.");
